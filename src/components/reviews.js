...
const reviews = () => (
    <div className="reviews">
      <a href="https://www.amazon.co.uk/gp/customer-reviews/R4EQ3OUYDN7KB/ref=cm_cr_dp_d_rvw_ttl?ie=UTF8&ASIN=B00J9UMY2O" className="reviews__review">
        <Rater style={{ marginBottom: '1em'}} total={5} rating={5} interactive={false} />
      ...
      <a href="https://www.amazon.co.uk/gp/customer-reviews/R1SDFJBY3A2XK0/ref=cm_cr_dp_d_rvw_ttl?ie=UTF8&ASIN=B00J9UMY2O" className="reviews__review">
        <Rater style={{marginBottom: '1em'}} total={4} rating={5} interactive={false} />
      ...
      <a href="https://www.amazon.co.uk/gp/customer-reviews/RC45300502C1P/ref=cm_cr_dp_d_rvw_ttl?ie=UTF8&ASIN=B00J9UMY2O" className="reviews__review">
        <Rater style={{marginBottom: '1em'}} total={4} rating={5} interactive={false} />
